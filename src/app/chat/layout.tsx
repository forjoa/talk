...
export default async function ChatLayout({
  ...
  return (
    <div className='flex h-screen w-full flex-col md:flex-row overflow-hidden'>
      <div className='border-r border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-gray-950 h-0 md:h-full md:w-72 w-full'>
        <div className='hidden md:flex h-[100px] items-center justify-between border-b border-gray-200 px-4 dark:border-gray-800'>
          <div className='flex flex-col py-4 gap-2 w-full'>
            ...
            {usersSearched.length !== 0 && (
              <div className='absolute top-[100px] left-0 bg-gray-800 z-10 w-full md:w-[300px] rounded-b-xl'>
