  ...
  return (
    <>
      <div className='hidden md:flex h-full flex-col items-center justify-center'>
        <p className='text-xl'>
          Welcome to Talk your new favorite Next.js chat aplicacion
        </p>
      </div>
      <div className='border-r border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-gray-950 md:h-0 h-full md:w-72 w-full'>
